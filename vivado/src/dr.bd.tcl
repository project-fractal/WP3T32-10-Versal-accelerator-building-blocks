...
if { $list_projs eq "" } {
  create_project project_1 myproj -part xcvc1902-vsva2197-1LP-e-S
...
set_property USER_COMMENTS.comment0 "Fractal Extensible Embedded Platform for Versal AI Core (VCK190)
Note:
