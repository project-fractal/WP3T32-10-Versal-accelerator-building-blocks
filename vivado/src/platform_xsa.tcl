...
set_param board.repoPaths ./src/board_repo/boards/Xilinx/vck190
...
create_project -f ${PLATFORM_NAME} ${BUILD_DIR} -part $DEVICE_NAME
...
## ===================================================================================
make_wrapper -files [get_files ${BUILD_DIR}/${PLATFORM_NAME}.srcs/sources_1/bd/${PLATFORM_NAME}/${PLATFORM_NAME}.bd] -top
add_files -norecurse ${BUILD_DIR}/${PLATFORM_NAME}.srcs/sources_1/bd/${PLATFORM_NAME}/hdl/${PLATFORM_NAME}_wrapper.v
...
## ===================================================================================
generate_target all [get_files ${BUILD_DIR}/${PLATFORM_NAME}.srcs/sources_1/bd/${PLATFORM_NAME}/${PLATFORM_NAME}.bd]
